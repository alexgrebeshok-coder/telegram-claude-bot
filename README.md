...
[![CI](https://github.com/alexgrebeshok-coder/telegram-claude-bot/actions/workflows/ci.yml/badge.svg)](https://github.com/alexgrebeshok-coder/telegram-claude-bot/actions/workflows/ci.yml)
...
- **Выбор модели**: Claude Opus 4.8, Sonnet 4.6, Haiku 4.5, **Fable 5** и **GLM 4.7** (удалённый API Zhipu AI)
...
| 🤖 Модель | Выбрать модель (Opus/Sonnet/Haiku/Fable 5/GLM) |
